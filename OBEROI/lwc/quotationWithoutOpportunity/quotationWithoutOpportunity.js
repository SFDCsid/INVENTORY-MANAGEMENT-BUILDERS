...
import getProperty from '@salesforce/apex/Quotation_Without_Opp.getProperty';
//import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import getCarParkingList from '@salesforce/apex/Quotation_Without_Opp.getCarParkingList';
//import { getRecord } from 'lightning/uiRecordApi';
//import getOpportunity from '@salesforce/apex/Quotation_Without_Opp.getOpportunity';
import getDiscountList from '@salesforce/apex/Quotation_Without_Opp.getDiscountList';
import getBillingPlanList from '@salesforce/apex/Quotation_Without_Opp.getBillingPlanList';
import getSAPPricingList from '@salesforce/apex/Quotation_Without_Opp.getSAPPricingList';
import getAdditionChargsList from '@salesforce/apex/Quotation_Without_Opp.getAdditionChargsList';
import applyCarParking from '@salesforce/apex/Quotation_Without_Opp.applyCarParking';
import applyDiscount from '@salesforce/apex/Quotation_Without_Opp.applyDiscount';
import removeDiscount from '@salesforce/apex/Quotation_Without_Opp.removeDiscount';
import getAppliedDiscounts from '@salesforce/apex/Quotation_Without_Opp.getAppliedDiscounts';
import getPlanDetail from '@salesforce/apex/Quotation_Without_Opp.getPlanDetail';
import addPlanRow from '@salesforce/apex/Quotation_Without_Opp.addPlanRow';
import updatedPlanDetails from '@salesforce/apex/Quotation_Without_Opp.updatePlanDetails';
//import getNPV from '@salesforce/apex/Quotation_Without_Opp.getNPV';
import saveQuotation from '@salesforce/apex/Quotation_Without_Opp.saveQuotation';
//import { NavigationMixin } from 'lightning/navigation';
import getEarmarkedParkingDetails from '@salesforce/apex/Quotation_Without_Opp.getEarmarkedParkingDetails';
import getParkingCharges from '@salesforce/apex/Quotation_Without_Opp.getParkingCharges';
//import getChargesName from '@salesforce/apex/Quotation_Without_Opp.getChargesName';
...
resetMethod(event) {
    window.open('/apex/Quotation_Without_Opportunity?unitId='+this.unitId,'_parent');
    this.hidebutton = true;
