({
  ...
  /*  calculateFSL: function(component, event, helper){
        ...
        document.getElementById(keyid+"-amounntBSP").value= basicCost;
    },*/
    calculateBSP: function(component, event, helper){
      ...
      /*  var clickId = target;		//0-perBSP
        ...
        var index = clickId.indexOf("-");
        var keyid = clickId.substr(0,(index));
        var totalCost=component.get('v.totalAmount');
        var perAmount = (totalCost/100)*targetValue;
        document.getElementById(keyid+"-amounntBSP").value= perAmount;   */
    },  
})