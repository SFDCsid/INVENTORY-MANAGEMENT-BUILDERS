({
    ...
    removeDeletedRow: function(component, event, helper) {
        ...
        console.log('txtValtxtVal'+txtVal);
        var txtValkey = AllRowsList[rowIndex].Terms_of_Payment_Key__c;
        console.log('txtValkeytxtValkey'+txtValkey);
        var checkMin = helper.checkMinLimit(component, event, helper, txtValkey);
       // alert('checkMin'+checkMin);
       console.log('checkMincheckMin'+checkMin);
        if(checkMin == true){
    ...
    calculateBSP: function(component, event, helper){
        ...
        //component.set('v.changePercent',targetValue);
		console.log('Aditya'+targetValue);
		console.log('Bhasin'+keyid);
        //alert('Aditya'+targetValue);
		//alert('Bhasin'+keyid);
        ...
        console.log('AAAAAAAAAAAAAAAAAAA'+RowItemList[1].Percentage_Of_Value_To_Be_Invoiced__c);
