...
import getCredit from '@salesforce/apex/CreditController.getCredit';
import getCreditcard from '@salesforce/apex/CreditCardContoller.getCreditcard';
import getDebitcard from '@salesforce/apex/DebitCardController.getDebitcard';
import getAmount from '@salesforce/apex/AmountController.getAmount';
export default class EmployeeDatatable extends LightningElement {
    ...
    buttonHandler() {
        ...
        const myJSON = JSON.stringify(arr, ["Product_Name__c"]);
        //{"producname":"Amazon"}
        ...
        if (obj[0].Product_Name__c == 'Pural Gateway') {

            console.log('sid');
            this.firstVisible = false;
            this.tableVisible = false;
            this.secVisible = false;
        } else if (obj[0].Product_Name__c == 'Credit Card') {
            this.thirdVisible = false;
            this.secVisible = true;
            // this.tableVisible = false;
            // this.firstVisible = true;
        } else if (obj[0].Product_Name__c == 'Debit Card') {
            this.mistakeVisible = false;
            this.secVisible = true;
            //this.tableVisible = false;
            //this.firstVisible = true;
            // this.secVisible =true;
        } else if (obj[0].Product_Name__c == 'Credit Card EMI') {
            this.fourthVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
        } else if (obj[0].Product_Name__c == 'Debit Card EMI') {
        ...
        } else if (obj[0].Product_Name__c == 'Cardless EMI') {
            this.sixthVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;

        } else if (obj[0].Product_Name__c == 'Wallet') {
            this.seventhVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;

        } else if (obj[0].Product_Name__c == 'Net Banking') {
            this.eightVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;

        } else if (obj[0].Product_Name__c == 'Pay by Points') {
        ...
        }  else if (obj[0].Product_Name__c == 'ALL') {
        ...
        } else if (obj[0].Product_Name__c == 'Rupay Credit Card') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
        } else if (obj[0].Product_Name__c == 'Amex Credit Card') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
        } else if (obj[0].Product_Name__c == 'Visa Credit Card') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
        } else if (obj[0].Product_Name__c == 'MasterCard Credit Card') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
            this.fourthVisible = true;
        } else if (obj[0].Product_Name__c == 'Rupay Credit Card EMI') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
            this.fourthVisible = true;
        } else if (obj[0].Product_Name__c == 'Amex Credit Card EMI') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
            this.fourthVisible = true;
        } else if (obj[0].Product_Name__c == 'Visa Credit Card EMI') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
            this.thirdVisible = true;
            this.fourthVisible = true;
        } else if (obj[0].Product_Name__c == 'MasterCard Credit Card EMI') {
            this.tenthnewVisible = true;
            //this.thirdVisible = false;
            this.tableVisible = false;
            this.firstVisible = true;
        ...
        else if (obj[0].Product_Name__c == 'Amount') {
            //this.tenthnewVisible = true;
            //this.thirdVisible = false;
            //this.tableVisible = false;
           // this.firstVisible = true;
    ...
    @wire(getProducts) productRecords({ error, data }) {
        if (data) {
            console.log(data);
            this.data = data;
        }
    ...
    @wire(getCredit) creditRecords({ error, data }) {
        if (data) {
            this.dat = data;
    ...
    @wire(getCreditcard) creditcardRecords({ error, data }) {
        if (data) {
            this.third = data;
    ...
    @wire(getDebitcard) debitcardRecords({ error, data }) {
        if (data) {
            this.mistak = data;

        }
        else if (error) {
            this.mistak = undefined;
        }
    }
    ...
    @wire(getAmount) AmountRecords({ error, data }) {
        if (data) {
            this.tenthtData = data;

        }
        else if (error) {
            this.tenthtData = undefined;
        }
    }
